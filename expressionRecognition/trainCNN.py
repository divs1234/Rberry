...
X_train = np.load('/home/dg/Desktop/hf/webCamEmocognizer/data/Scaled.bin.npy')
Y_tr_labels = np.load('/home/dg/Desktop/hf/webCamEmocognizer/data/labels.bin.npy')
...
model.save_weights('/home/dg/Desktop/hf/webCamEmocognizer/models/Face_model_weights.h5')
open('/home/dg/Desktop/hf/webCamEmocognizer/models/Face_model_architecture.json', 'w').write(json_string)
model.save_weights('/home/dg/Desktop/hf/webCamEmocognizer/models/Face_model_weights.h5')
